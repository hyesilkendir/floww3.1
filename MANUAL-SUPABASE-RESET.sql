-- 🚀 MANUEL SUPABASE RESET - SQL EDİTOR'DA ÇALIŞTIRIN
-- https://supabase.com/dashboard → floww3 → SQL Editor
...
DROP TABLE IF EXISTS users CASCADE; -- Remove custom users - use auth.users
...
-- ==========================================
-- 3️⃣ CREATE CLEAN TABLES (snake_case only)
-- ==========================================
